...
export const projects: Project[] = [
    ...
    },
    {
        ...
        tagline: 'Web • React • Tailwind • Firebase',
    ...
    },
    {
        ...
        slug: 'habitsense',
        title: 'HabitSense',
        tagline: 'Mobile • React Native • Firebase',
        category: ['mobile'],
    ...
    },
    {
        ...
        slug: 'mathmentor-ai',
        title: 'MathMentor AI',
        tagline: 'Web • MERN • React Native • AI & Math',
        category: ['web', 'fullstack', 'mobile'],
        description: 'A platform for learning algorithms and data structures',
        tech_stack: ['React', 'Node', 'Express', 'MongoDB', 'Tailwind', 'Groq AI API'],
        image: '',
        featured: true,
        links: {
